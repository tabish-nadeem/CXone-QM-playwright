...
BeforeAll({ timeout: 400 * 1000 }, async () => {
    ...
    await FeatureToggleUtils.addTenantToFeature(FEATURE_TOGGLES.BEHAVIOR_MATRICS, userDetails.orgName, userToken);
...
AfterAll({ timeout: 60 * 1000 }, async () => {
    ...
    await FeatureToggleUtils.removeTenantFromFeature(FEATURE_TOGGLES.ENGAGE_RECORDING_FT, userDetails.orgName, userToken);
